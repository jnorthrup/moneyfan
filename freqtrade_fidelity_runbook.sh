...
while [[ $# -gt 0 ]]; do
  case "$1" in
    ...
    -h|--help)
      usage; exit 0 ;;
    receiver|contract-proxy|bridge|smoke|traffic-replay|traffic-validate|sampler-smoke|sampler-validate|sampler-conformance|sampler-trace-report|sampler-audit|pipeline|replay|report|compare|history|prune|all|print)
